...
from approach.lstm.callbacks import time_callback as tc
from approach.lstm.callbacks import clean_models_callback as cm

def _training_model(vec, ac_weights, rl_weights, output_folder, args, class_weights=None):
