...
def training_model(max_trace_length, n_activity, num_classes, train_batches, validation_data, title, class_weights_dic,
                   output_file):
    model = Sequential()
    reg = 0.0001
    # =============================================================================
    ...
    # Generators
    training_generator = my_generator.DataGenerator(train_batches)
